package open.source.agriculture.chaquitaclla.chaquitacllaplatformopen.iam.infrastructure.authorization.sfs.configuration;
...
import open.source.agriculture.chaquitaclla.chaquitacllaplatformopen.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import open.source.agriculture.chaquitaclla.chaquitacllaplatformopen.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import open.source.agriculture.chaquitaclla.chaquitacllaplatformopen.iam.infrastructure.tokens.jwt.BearerTokenService;
    ...
    http.csrf(csrfConfigurer -> csrfConfigurer.disable())
        ...
        .authorizeHttpRequests(
            authorizeRequests -> authorizeRequests.requestMatchers(
                ...
                "/swagger-ui/**", "/swagger-resources/**", "/webjars/**","/api/v1/products/**")
                .permitAll()
                .anyRequest()
                .authenticated());
